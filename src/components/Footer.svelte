  ...
  <div class="container mx-auto px-6">
    <div class="grid grid-cols-1 md:grid-cols-3 gap-12">
      ...
      <div>
        ...
        <p class="mb-6">
          Creating the ultimate outdoor living experience with premium custom
          kitchens and grills.
        </p>
        ...
        <ul class="space-y-4">
          ...
          <li class="flex items-center gap-3">
            <svg
              ...
              ></path></svg
            >
            <span>info@wassisoutdoorkitchens.com</span>
          </li>
        </ul>
      </div>
    </div>
    ...
    <div class="border-t border-gray-800 mt-12 pt-8 text-center text-sm">
      <p>&copy; {currentYear} Wassis' Outdoor Kitchens. All rights reserved.</p>
    </div>
  </div>
</footer>
