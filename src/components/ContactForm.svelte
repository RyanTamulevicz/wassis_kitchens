...
>
  ...
  <div class="container mx-auto px-6 relative z-10">
    ...
    >
      ...
      {#if isSuccess}
        <div
          class="bg-green-500/20 border border-green-500 text-green-300 p-6 rounded-lg text-center mb-8 animate-fade-in"
        >
